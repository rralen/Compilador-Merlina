...
def draw_shapes(code):
    ...
    for match in line_matches:
        ...
        if orientation == 0:  # Línea vertical
            draw_line(start_x, start_y, length, scale_factor,width=2,orientation='vertical')
        else:  # Línea horizontal
            draw_line(start_x, start_y, length, scale_factor,width=2,orientation='horizontal')
